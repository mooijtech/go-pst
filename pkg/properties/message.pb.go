...
type Message struct {
	...
	AutoProcessState *int32 `protobuf:"varint,1,opt,name=auto_process_state,json=autoProcessState,proto3,oneof" json:"auto_process_state,omitempty" msg:"2673063"` // @gotags: msg:"2673063"
	...
	ClassificationDescription *string `protobuf:"bytes,4,opt,name=classification_description,json=classificationDescription,proto3,oneof" json:"classification_description,omitempty" msg:"26762331"` // @gotags: msg:"26762331"
	// Contains the GUID that identifies the list of email classification categories used by a Message object.
	ClassificationGuid *string `protobuf:"bytes,5,opt,name=classification_guid,json=classificationGuid,proto3,oneof" json:"classification_guid,omitempty" msg:"26762431"` // @gotags: msg:"26762431"
	// Indicates whether the message uses any classification categories.
	ClassificationKeep *bool `protobuf:"varint,6,opt,name=classification_keep,json=classificationKeep,proto3,oneof" json:"classification_keep,omitempty" msg:"26762611"` // @gotags: msg:"26762611"
	...
	CurrentVersionName *string `protobuf:"bytes,13,opt,name=current_version_name,json=currentVersionName,proto3,oneof" json:"current_version_name,omitempty" msg:"26742831"` // @gotags: msg:"26742831"
	// Specifies the user-visible email account name through which the email message is sent.
	InternetAccountName *string `protobuf:"bytes,14,opt,name=internet_account_name,json=internetAccountName,proto3,oneof" json:"internet_account_name,omitempty" msg:"26752031"` // @gotags: msg:"26752031"
	// Specifies the email account ID through which the email message is sent.
	InternetAccountStamp *string `protobuf:"bytes,15,opt,name=internet_account_stamp,json=internetAccountStamp,proto3,oneof" json:"internet_account_stamp,omitempty" msg:"26752131"` // @gotags: msg:"26752131"
	...
	AlternateRecipientAllowed *bool `protobuf:"varint,34,opt,name=alternate_recipient_allowed,json=alternateRecipientAllowed,proto3,oneof" json:"alternate_recipient_allowed,omitempty" msg:"211"` // @gotags: msg:"211"
	...
	AssistantTelephoneNumber *string `protobuf:"bytes,39,opt,name=assistant_telephone_number,json=assistantTelephoneNumber,proto3,oneof" json:"assistant_telephone_number,omitempty" msg:"1489431"` // @gotags: msg:"1489431"
	// Specifies whether a client or server application will forego sending automated replies in response to this message.
	AutoResponseSuppress *int32 `protobuf:"varint,40,opt,name=auto_response_suppress,json=autoResponseSuppress,proto3,oneof" json:"auto_response_suppress,omitempty" msg:"163513"` // @gotags: msg:"163513"
	...
	BodyContentLocation *string `protobuf:"bytes,43,opt,name=body_content_location,json=bodyContentLocation,proto3,oneof" json:"body_content_location,omitempty" msg:"411631"` // @gotags: msg:"411631"
	...
	ClientSubmitTime *int64 `protobuf:"varint,45,opt,name=client_submit_time,json=clientSubmitTime,proto3,oneof" json:"client_submit_time,omitempty" msg:"5764"` // @gotags: msg:"5764"
	// Indicates a confidence level that the message is spam.
	ContentFilterSpamConfidenceLevel *int32 `protobuf:"varint,46,opt,name=content_filter_spam_confidence_level,json=contentFilterSpamConfidenceLevel,proto3,oneof" json:"content_filter_spam_confidence_level,omitempty" msg:"165023"` // @gotags: msg:"165023"
	// Contains an unchanging copy of the original subject.
	ConversationTopic *string `protobuf:"bytes,48,opt,name=conversation_topic,json=conversationTopic,proto3,oneof" json:"conversation_topic,omitempty" msg:"11231"` // @gotags: msg:"11231"
	...
	InternetMailOverrideFormat *int32 `protobuf:"varint,60,opt,name=internet_mail_override_format,json=internetMailOverrideFormat,proto3,oneof" json:"internet_mail_override_format,omitempty" msg:"227863"` // @gotags: msg:"227863"
	// Corresponds to the message-id field.
	InternetMessageId *string `protobuf:"bytes,61,opt,name=internet_message_id,json=internetMessageId,proto3,oneof" json:"internet_message_id,omitempty" msg:"414931"` // @gotags: msg:"414931"
	// Contains a list of message IDs that specify the messages to which this reply is related.
	InternetReferences *string `protobuf:"bytes,62,opt,name=internet_references,json=internetReferences,proto3,oneof" json:"internet_references,omitempty" msg:"415331"` // @gotags: msg:"415331"
	...
	LastModificationTime *int64 `protobuf:"varint,66,opt,name=last_modification_time,json=lastModificationTime,proto3,oneof" json:"last_modification_time,omitempty" msg:"1229664"` // @gotags: msg:"1229664"
	...
	MessageDeliveryTime *int64 `protobuf:"varint,71,opt,name=message_delivery_time,json=messageDeliveryTime,proto3,oneof" json:"message_delivery_time,omitempty" msg:"359064"` // @gotags: msg:"359064"
	...
	MessageHandlingSystemCommonName *string `protobuf:"bytes,73,opt,name=message_handling_system_common_name,json=messageHandlingSystemCommonName,proto3,oneof" json:"message_handling_system_common_name,omitempty" msg:"1486331"` // @gotags: msg:"1486331"
	// Indicates that the receiving mailbox owner is a primary or a carbon copy (Cc) recipient of this email message.
	MessageRecipientMe *bool `protobuf:"varint,74,opt,name=message_recipient_me,json=messageRecipientMe,proto3,oneof" json:"message_recipient_me,omitempty" msg:"8911"` // @gotags: msg:"8911"
	...
	MessageSizeExtended *float64 `protobuf:"fixed64,77,opt,name=message_size_extended,json=messageSizeExtended,proto3,oneof" json:"message_size_extended,omitempty" msg:"359220"` // @gotags: msg:"359220"
	...
	MobileTelephoneNumber *string `protobuf:"bytes,82,opt,name=mobile_telephone_number,json=mobileTelephoneNumber,proto3,oneof" json:"mobile_telephone_number,omitempty" msg:"1487631"` // @gotags: msg:"1487631"
	...
	NonDeliveryReportDiagCode *int32 `protobuf:"varint,84,opt,name=non_delivery_report_diag_code,json=nonDeliveryReportDiagCode,proto3,oneof" json:"non_delivery_report_diag_code,omitempty" msg:"30773"` // @gotags: msg:"30773"
	// Contains an integer value that indicates a reason for delivery failure.
	NonDeliveryReportReasonCode *int32 `protobuf:"varint,85,opt,name=non_delivery_report_reason_code,json=nonDeliveryReportReasonCode,proto3,oneof" json:"non_delivery_report_reason_code,omitempty" msg:"30763"` // @gotags: msg:"30763"
	// Specifies whether the client sends a non-read receipt.
	NonDeliveryReportStatusCode *int32 `protobuf:"varint,86,opt,name=non_delivery_report_status_code,json=nonDeliveryReportStatusCode,proto3,oneof" json:"non_delivery_report_status_code,omitempty" msg:"30783"` // @gotags: msg:"30783"
	// Contains the normalized subject of the message.
	NormalizedSubject *string `protobuf:"bytes,87,opt,name=normalized_subject,json=normalizedSubject,proto3,oneof" json:"normalized_subject,omitempty" msg:"361331"` // @gotags: msg:"361331"
	...
	OrganizationalIdNumber *string `protobuf:"bytes,89,opt,name=organizational_id_number,json=organizationalIdNumber,proto3,oneof" json:"organizational_id_number,omitempty" msg:"1486431"` // @gotags: msg:"1486431"
	// Contains the display name of the sender of the original message referenced by a report message.
	OriginalAuthorName *string `protobuf:"bytes,91,opt,name=original_author_name,json=originalAuthorName,proto3,oneof" json:"original_author_name,omitempty" msg:"7731"` // @gotags: msg:"7731"
	// Contains the delivery time, in UTC, from the original message.
	OriginalDeliveryTime *int64 `protobuf:"varint,92,opt,name=original_delivery_time,json=originalDeliveryTime,proto3,oneof" json:"original_delivery_time,omitempty" msg:"8564"` // @gotags: msg:"8564"
	// Contains the value of the PidTagDisplayBcc property (section 2.674) from the original message.
	OriginalDisplayBcc *string `protobuf:"bytes,93,opt,name=original_display_bcc,json=originalDisplayBcc,proto3,oneof" json:"original_display_bcc,omitempty" msg:"11431"` // @gotags: msg:"11431"
	// Contains the value of the PidTagDisplayCc property(section 2.675) from the original message.
	OriginalDisplayCc *string `protobuf:"bytes,94,opt,name=original_display_cc,json=originalDisplayCc,proto3,oneof" json:"original_display_cc,omitempty" msg:"11531"` // @gotags: msg:"11531"
	// Contains the value of the PidTagDisplayTo property (section 2.678) from the original message.
	OriginalDisplayTo *string `protobuf:"bytes,95,opt,name=original_display_to,json=originalDisplayTo,proto3,oneof" json:"original_display_to,omitempty" msg:"11631"` // @gotags: msg:"11631"
	// Designates the PidTagMessageClass property ([MS-OXCMSG] section 2.2.1.3) from the original message.
	OriginalMessageClass *string `protobuf:"bytes,97,opt,name=original_message_class,json=originalMessageClass,proto3,oneof" json:"original_message_class,omitempty" msg:"7531"` // @gotags: msg:"7531"
	// Contains the value of the original message sender's PidTagSenderAddressType property (section 2.1000).
	OriginalSenderAddressType *string `protobuf:"bytes,98,opt,name=original_sender_address_type,json=originalSenderAddressType,proto3,oneof" json:"original_sender_address_type,omitempty" msg:"10231"` // @gotags: msg:"10231"
	// Contains the value of the original message sender's PidTagSenderEmailAddress property (section 2.1001).
	OriginalSenderEmailAddress *string `protobuf:"bytes,99,opt,name=original_sender_email_address,json=originalSenderEmailAddress,proto3,oneof" json:"original_sender_email_address,omitempty" msg:"10331"` // @gotags: msg:"10331"
	...
	OriginalSenderName *string `protobuf:"bytes,101,opt,name=original_sender_name,json=originalSenderName,proto3,oneof" json:"original_sender_name,omitempty" msg:"9031"` // @gotags: msg:"9031"
	// Contains the sensitivity value of the original email message.
	OriginalSensitivity *int32 `protobuf:"varint,103,opt,name=original_sensitivity,json=originalSensitivity,proto3,oneof" json:"original_sensitivity,omitempty" msg:"463"` // @gotags: msg:"463"
	// Contains the address type of the end user who is represented by the original email message sender.
	OriginalSentRepresentingAddressType *string `protobuf:"bytes,104,opt,name=original_sent_representing_address_type,json=originalSentRepresentingAddressType,proto3,oneof" json:"original_sent_representing_address_type,omitempty" msg:"10431"` // @gotags: msg:"10431"
	// Contains the email address of the end user who is represented by the original email message sender.
	OriginalSentRepresentingEmailAddress *string `protobuf:"bytes,105,opt,name=original_sent_representing_email_address,json=originalSentRepresentingEmailAddress,proto3,oneof" json:"original_sent_representing_email_address,omitempty" msg:"10531"` // @gotags: msg:"10531"
	// Contains the display name of the end user who is represented by the original email message sender.
	OriginalSentRepresentingName *string `protobuf:"bytes,107,opt,name=original_sent_representing_name,json=originalSentRepresentingName,proto3,oneof" json:"original_sent_representing_name,omitempty" msg:"9331"` // @gotags: msg:"9331"
	...
	OriginalSubmitTime *int64 `protobuf:"varint,110,opt,name=original_submit_time,json=originalSubmitTime,proto3,oneof" json:"original_submit_time,omitempty" msg:"7864"` // @gotags: msg:"7864"
	// Indicates whether an email sender requests an email delivery receipt from the messaging system.
	OriginatorDeliveryReportRequested *bool `protobuf:"varint,111,opt,name=originator_delivery_report_requested,json=originatorDeliveryReportRequested,proto3,oneof" json:"originator_delivery_report_requested,omitempty" msg:"3511"` // @gotags: msg:"3511"
	// Specifies whether an email sender requests suppression of nondelivery receipts.
	OriginatorNonDeliveryReportRequested *bool `protobuf:"varint,112,opt,name=originator_non_delivery_report_requested,json=originatorNonDeliveryReportRequested,proto3,oneof" json:"originator_non_delivery_report_requested,omitempty" msg:"308011"` // @gotags: msg:"308011"
	// Contains the name of the mail user's other locality, such as the town or city.
	OtherAddressCity *string `protobuf:"bytes,113,opt,name=other_address_city,json=otherAddressCity,proto3,oneof" json:"other_address_city,omitempty" msg:"1494331"` // @gotags: msg:"1494331"
	// Contains the name of the mail user's other country/region.
	OtherAddressCountry *string `protobuf:"bytes,114,opt,name=other_address_country,json=otherAddressCountry,proto3,oneof" json:"other_address_country,omitempty" msg:"1494431"` // @gotags: msg:"1494431"
	// Contains the postal code for the mail user's other postal address.
	OtherAddressPostalCode *string `protobuf:"bytes,115,opt,name=other_address_postal_code,json=otherAddressPostalCode,proto3,oneof" json:"other_address_postal_code,omitempty" msg:"1494531"` // @gotags: msg:"1494531"
	// Contains the number or identifier of the mail user's other post office box.
	OtherAddressPostOfficeBox *string `protobuf:"bytes,116,opt,name=other_address_post_office_box,json=otherAddressPostOfficeBox,proto3,oneof" json:"other_address_post_office_box,omitempty" msg:"1494831"` // @gotags: msg:"1494831"
	// Contains the name of the mail user's other state or province.
	OtherAddressStateOrProvince *string `protobuf:"bytes,117,opt,name=other_address_state_or_province,json=otherAddressStateOrProvince,proto3,oneof" json:"other_address_state_or_province,omitempty" msg:"1494631"` // @gotags: msg:"1494631"
	// Contains the mail user's other street address.
	OtherAddressStreet *string `protobuf:"bytes,118,opt,name=other_address_street,json=otherAddressStreet,proto3,oneof" json:"other_address_street,omitempty" msg:"1494731"` // @gotags: msg:"1494731"
	// Contains an alternate telephone number for the mail user.
	OtherTelephoneNumber *string `protobuf:"bytes,119,opt,name=other_telephone_number,json=otherTelephoneNumber,proto3,oneof" json:"other_telephone_number,omitempty" msg:"1487931"` // @gotags: msg:"1487931"
	// Contains the mail user's pager telephone number.
	PagerTelephoneNumber *string `protobuf:"bytes,120,opt,name=pager_telephone_number,json=pagerTelephoneNumber,proto3,oneof" json:"pager_telephone_number,omitempty" msg:"1488131"` // @gotags: msg:"1488131"
	...
	ReadReceiptRequested *bool `protobuf:"varint,123,opt,name=read_receipt_requested,json=readReceiptRequested,proto3,oneof" json:"read_receipt_requested,omitempty" msg:"4111"` // @gotags: msg:"4111"
	...
	ReceivedByEmailAddress *string `protobuf:"bytes,125,opt,name=received_by_email_address,json=receivedByEmailAddress,proto3,oneof" json:"received_by_email_address,omitempty" msg:"11831"` // @gotags: msg:"11831"
	...
	ReceivedRepresentingAddressType *string `protobuf:"bytes,129,opt,name=received_representing_address_type,json=receivedRepresentingAddressType,proto3,oneof" json:"received_representing_address_type,omitempty" msg:"11931"` // @gotags: msg:"11931"
	// Contains the email address for the end user represented by the receiving mailbox owner.
	ReceivedRepresentingEmailAddress *string `protobuf:"bytes,130,opt,name=received_representing_email_address,json=receivedRepresentingEmailAddress,proto3,oneof" json:"received_representing_email_address,omitempty" msg:"12031"` // @gotags: msg:"12031"
	// Contains the display name for the end user represented by the receiving mailbox owner.
	ReceivedRepresentingName *string `protobuf:"bytes,132,opt,name=received_representing_name,json=receivedRepresentingName,proto3,oneof" json:"received_representing_name,omitempty" msg:"6831"` // @gotags: msg:"6831"
	...
	RemoteMessageTransferAgent *string `protobuf:"bytes,135,opt,name=remote_message_transfer_agent,json=remoteMessageTransferAgent,proto3,oneof" json:"remote_message_transfer_agent,omitempty" msg:"310531"` // @gotags: msg:"310531"
	...
	ReportDisposition *string `protobuf:"bytes,137,opt,name=report_disposition,json=reportDisposition,proto3,oneof" json:"report_disposition,omitempty" msg:"12831"` // @gotags: msg:"12831"
	// Contains a description of the action that a client has performed on behalf of a user (report messages only).
	ReportDispositionMode *string `protobuf:"bytes,138,opt,name=report_disposition_mode,json=reportDispositionMode,proto3,oneof" json:"report_disposition_mode,omitempty" msg:"12931"` // @gotags: msg:"12931"
	// Contains the value of the Reporting-MTA field for a delivery status notification, as specified in [RFC3464].
	ReportingMessageTransferAgent *string `protobuf:"bytes,139,opt,name=reporting_message_transfer_agent,json=reportingMessageTransferAgent,proto3,oneof" json:"reporting_message_transfer_agent,omitempty" msg:"2665631"` // @gotags: msg:"2665631"
	...
	// Specifies the number of days that a Message object can remain unarchived.
	RetentionPeriod *int32 `protobuf:"varint,142,opt,name=retention_period,json=retentionPeriod,proto3,oneof" json:"retention_period,omitempty" msg:"123143"` // @gotags: msg:"123143"
	...
	SenderAddressType *string `protobuf:"bytes,145,opt,name=sender_address_type,json=senderAddressType,proto3,oneof" json:"sender_address_type,omitempty" msg:"310231"` // @gotags: msg:"310231"
	// Contains the email address of the sending mailbox owner.
	SenderEmailAddress *string `protobuf:"bytes,146,opt,name=sender_email_address,json=senderEmailAddress,proto3,oneof" json:"sender_email_address,omitempty" msg:"310331"` // @gotags: msg:"310331"
	// Reports the results of a Sender-ID check.
	SenderIdStatus *int32 `protobuf:"varint,148,opt,name=sender_id_status,json=senderIdStatus,proto3,oneof" json:"sender_id_status,omitempty" msg:"165053"` // @gotags: msg:"165053"
	...
	SendInternetEncoding *int32 `protobuf:"varint,151,opt,name=send_internet_encoding,json=sendInternetEncoding,proto3,oneof" json:"send_internet_encoding,omitempty" msg:"149613"` // @gotags: msg:"149613"
	...
	SentRepresentingAddressType *string `protobuf:"bytes,154,opt,name=sent_representing_address_type,json=sentRepresentingAddressType,proto3,oneof" json:"sent_representing_address_type,omitempty" msg:"10031"` // @gotags: msg:"10031"
	// Contains an email address for the end user who is represented by the sending mailbox owner.
	SentRepresentingEmailAddress *string `protobuf:"bytes,155,opt,name=sent_representing_email_address,json=sentRepresentingEmailAddress,proto3,oneof" json:"sent_representing_email_address,omitempty" msg:"10131"` // @gotags: msg:"10131"
	// Contains the display name for the end user who is represented by the sending mailbox owner.
	SentRepresentingName *string `protobuf:"bytes,157,opt,name=sent_representing_name,json=sentRepresentingName,proto3,oneof" json:"sent_representing_name,omitempty" msg:"6631"` // @gotags: msg:"6631"
	...
	SupplementaryInfo *string `protobuf:"bytes,163,opt,name=supplementary_info,json=supplementaryInfo,proto3,oneof" json:"supplementary_info,omitempty" msg:"309931"` // @gotags: msg:"309931"
	// Contains an Address Book object's display name that is transmitted with the message.
	TransmittableDisplayName *string `protobuf:"bytes,164,opt,name=transmittable_display_name,json=transmittableDisplayName,proto3,oneof" json:"transmittable_display_name,omitempty" msg:"1488031"` // @gotags: msg:"1488031"
	// Contains transport-specific message envelope information for email.
	TransportMessageHeaders *string `protobuf:"bytes,165,opt,name=transport_message_headers,json=transportMessageHeaders,proto3,oneof" json:"transport_message_headers,omitempty" msg:"12531"` // @gotags: msg:"12531"
}

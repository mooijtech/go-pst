...
type Journal struct {
	...
	LogDocumentPosted *bool `protobuf:"varint,1,opt,name=log_document_posted,json=logDocumentPosted,proto3,oneof" json:"log_document_posted,omitempty"` // @gotags: propertyID:"269345"
	// Indicates whether the document was printed during journaling.
	LogDocumentPrinted *bool `protobuf:"varint,2,opt,name=log_document_printed,json=logDocumentPrinted,proto3,oneof" json:"log_document_printed,omitempty"` // @gotags: propertyID:"269326"
	// Indicates whether the document was sent to a routing recipient during journaling.
	LogDocumentRouted *bool `protobuf:"varint,3,opt,name=log_document_routed,json=logDocumentRouted,proto3,oneof" json:"log_document_routed,omitempty"` // @gotags: propertyID:"269344"
	// Indicates whether the document was saved during journaling.
	LogDocumentSaved *bool `protobuf:"varint,4,opt,name=log_document_saved,json=logDocumentSaved,proto3,oneof" json:"log_document_saved,omitempty"` // @gotags: propertyID:"269327"
	// Contains the duration, in minutes, of the activity.
	LogDuration *int32 `protobuf:"varint,5,opt,name=log_duration,json=logDuration,proto3,oneof" json:"log_duration,omitempty"` // @gotags: propertyID:"269319"
	// Contains the time, in UTC, at which the activity ended.
	LogEnd *int64 `protobuf:"varint,6,opt,name=log_end,json=logEnd,proto3,oneof" json:"log_end,omitempty"` // @gotags: propertyID:"269320"
	// Contains metadata about the Journal object.
	LogFlags *int32 `protobuf:"varint,7,opt,name=log_flags,json=logFlags,proto3,oneof" json:"log_flags,omitempty"` // @gotags: propertyID:"269324"
	// Contains the time, in UTC, at which the activity began.
	LogStart *int64 `protobuf:"varint,8,opt,name=log_start,json=logStart,proto3,oneof" json:"log_start,omitempty"` // @gotags: propertyID:"269318"
	// Briefly describes the journal activity that is being recorded.
	LogType *string `protobuf:"bytes,9,opt,name=log_type,json=logType,proto3,oneof" json:"log_type,omitempty"` // @gotags: propertyID:"269312"
	// Contains an expanded description of the journal activity that is being recorded.
	LogTypeDesc *string `protobuf:"bytes,10,opt,name=log_type_desc,json=logTypeDesc,proto3,oneof" json:"log_type_desc,omitempty"` // @gotags: propertyID:"269346"
}

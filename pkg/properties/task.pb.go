...
type Task struct {
	...
	FlagString *int32 `protobuf:"varint,1,opt,name=flag_string,json=flagString,proto3,oneof" json:"flag_string,omitempty"` // @gotags: propertyID:"267648"
	// Indicates whether a time-flagged Message object is complete.
	PercentComplete *float64 `protobuf:"fixed64,3,opt,name=percent_complete,json=percentComplete,proto3,oneof" json:"percent_complete,omitempty"` // @gotags: propertyID:"263170"
	// Indicates the acceptance state of the task.
	TaskAcceptanceState *int32 `protobuf:"varint,4,opt,name=task_acceptance_state,json=taskAcceptanceState,proto3,oneof" json:"task_acceptance_state,omitempty"` // @gotags: propertyID:"263242"
	// Indicates whether a task assignee has replied to a task request for this Task object.
	TaskAccepted *bool `protobuf:"varint,5,opt,name=task_accepted,json=taskAccepted,proto3,oneof" json:"task_accepted,omitempty"` // @gotags: propertyID:"263176"
	// Indicates the number of minutes that the user actually spent working on a task.
	TaskActualEffort *int32 `protobuf:"varint,6,opt,name=task_actual_effort,json=taskActualEffort,proto3,oneof" json:"task_actual_effort,omitempty"` // @gotags: propertyID:"263200"
	// Specifies the name of the user that last assigned the task.
	TaskAssigner *string `protobuf:"bytes,7,opt,name=task_assigner,json=taskAssigner,proto3,oneof" json:"task_assigner,omitempty"` // @gotags: propertyID:"263233"
	// Indicates that the task is complete.
	TaskComplete *bool `protobuf:"varint,9,opt,name=task_complete,json=taskComplete,proto3,oneof" json:"task_complete,omitempty"` // @gotags: propertyID:"263212"
	// The client can set this property, but it has no impact on the Task-Related Objects Protocol and is ignored by the server.
	TaskCustomFlags *int32 `protobuf:"varint,10,opt,name=task_custom_flags,json=taskCustomFlags,proto3,oneof" json:"task_custom_flags,omitempty"` // @gotags: propertyID:"263273"
	// Specifies the date when the user completed work on the task.
	TaskDateCompleted *int64 `protobuf:"varint,11,opt,name=task_date_completed,json=taskDateCompleted,proto3,oneof" json:"task_date_completed,omitempty"` // @gotags: propertyID:"263183"
	// Indicates whether new occurrences remain to be generated.
	TaskDeadOccurrence *bool `protobuf:"varint,12,opt,name=task_dead_occurrence,json=taskDeadOccurrence,proto3,oneof" json:"task_dead_occurrence,omitempty"` // @gotags: propertyID:"263177"
	// Specifies the date by which the user expects work on the task to be complete.
	TaskDueDate *int64 `protobuf:"varint,13,opt,name=task_due_date,json=taskDueDate,proto3,oneof" json:"task_due_date,omitempty"` // @gotags: propertyID:"263173"
	// Indicates the number of minutes that the user expects to work on a task.
	TaskEstimatedEffort *int32 `protobuf:"varint,14,opt,name=task_estimated_effort,json=taskEstimatedEffort,proto3,oneof" json:"task_estimated_effort,omitempty"` // @gotags: propertyID:"263201"
	...
	TaskfCreator *bool `protobuf:"varint,15,opt,name=taskf_creator,json=taskfCreator,proto3,oneof" json:"taskf_creator,omitempty"` // @gotags: propertyID:"263214"
	// Indicates the accuracy of the PidLidTaskOwner property (section 2.328).
	TaskfFixOffline *bool `protobuf:"varint,16,opt,name=taskf_fix_offline,json=taskfFixOffline,proto3,oneof" json:"taskf_fix_offline,omitempty"` // @gotags: propertyID:"263244"
	// Indicates whether the task includes a recurrence pattern.
	TaskfRecurring *bool `protobuf:"varint,17,opt,name=taskf_recurring,json=taskfRecurring,proto3,oneof" json:"taskf_recurring,omitempty"` // @gotags: propertyID:"263238"
	// Indicates the type of change that was last made to the Task object.
	TaskHistory *int32 `protobuf:"varint,19,opt,name=task_history,json=taskHistory,proto3,oneof" json:"task_history,omitempty"` // @gotags: propertyID:"263210"
	// Contains the name of the user who most recently assigned the task, or the user to whom it was most recently assigned.
	TaskLastDelegate *string `protobuf:"bytes,20,opt,name=task_last_delegate,json=taskLastDelegate,proto3,oneof" json:"task_last_delegate,omitempty"` // @gotags: propertyID:"263237"
	// Contains the date and time of the most recent change made to the Task object.
	TaskLastUpdate *int64 `protobuf:"varint,21,opt,name=task_last_update,json=taskLastUpdate,proto3,oneof" json:"task_last_update,omitempty"` // @gotags: propertyID:"263205"
	// Contains the name of the most recent user to have been the owner of the task.
	TaskLastUser *string `protobuf:"bytes,22,opt,name=task_last_user,json=taskLastUser,proto3,oneof" json:"task_last_user,omitempty"` // @gotags: propertyID:"263234"
	// Specifies the assignment status of the embedded Task object.
	TaskMode *int32 `protobuf:"varint,23,opt,name=task_mode,json=taskMode,proto3,oneof" json:"task_mode,omitempty"` // @gotags: propertyID:"267304"
	// Provides optimization hints about the recipients of a Task object.
	TaskMultipleRecipients *int32 `protobuf:"varint,24,opt,name=task_multiple_recipients,json=taskMultipleRecipients,proto3,oneof" json:"task_multiple_recipients,omitempty"` // @gotags: propertyID:"263232"
	...
	TaskNoCompute *bool `protobuf:"varint,25,opt,name=task_no_compute,json=taskNoCompute,proto3,oneof" json:"task_no_compute,omitempty"` // @gotags: propertyID:"263236"
	// Provides an aid to custom sorting of Task objects.
	TaskOrdinal *int32 `protobuf:"varint,26,opt,name=task_ordinal,json=taskOrdinal,proto3,oneof" json:"task_ordinal,omitempty"` // @gotags: propertyID:"263235"
	// Contains the name of the owner of the task.
	TaskOwner *string `protobuf:"bytes,27,opt,name=task_owner,json=taskOwner,proto3,oneof" json:"task_owner,omitempty"` // @gotags: propertyID:"263215"
	// Indicates the role of the current user relative to the Task object.
	TaskOwnership *int32 `protobuf:"varint,28,opt,name=task_ownership,json=taskOwnership,proto3,oneof" json:"task_ownership,omitempty"` // @gotags: propertyID:"263241"
	...
	TaskResetReminder *bool `protobuf:"varint,30,opt,name=task_reset_reminder,json=taskResetReminder,proto3,oneof" json:"task_reset_reminder,omitempty"` // @gotags: propertyID:"263175"
	// Not used. The client can set this property, but it has no impact on the Task-Related Objects Protocol and is ignored by the server.
	TaskRole *string `protobuf:"bytes,31,opt,name=task_role,json=taskRole,proto3,oneof" json:"task_role,omitempty"` // @gotags: propertyID:"263239"
	// Specifies the date on which the user expects work on the task to begin.
	TaskStartDate *int64 `protobuf:"varint,32,opt,name=task_start_date,json=taskStartDate,proto3,oneof" json:"task_start_date,omitempty"` // @gotags: propertyID:"263172"
	// Indicates the current assignment state of the Task object.
	TaskState *int32 `protobuf:"varint,33,opt,name=task_state,json=taskState,proto3,oneof" json:"task_state,omitempty"` // @gotags: propertyID:"263203"
	// Specifies the status of a task.
	TaskStatus *int32 `protobuf:"varint,34,opt,name=task_status,json=taskStatus,proto3,oneof" json:"task_status,omitempty"` // @gotags: propertyID:"263169"
	...
	TaskStatusOnComplete *bool `protobuf:"varint,35,opt,name=task_status_on_complete,json=taskStatusOnComplete,proto3,oneof" json:"task_status_on_complete,omitempty"` // @gotags: propertyID:"263209"
	// Indicates whether the task assignee has been requested to send a task update when the assigned Task object changes.
	TaskUpdates *bool `protobuf:"varint,36,opt,name=task_updates,json=taskUpdates,proto3,oneof" json:"task_updates,omitempty"` // @gotags: propertyID:"263211"
	// Indicates which copy is the latest update of a Task object.
	TaskVersion *int32 `protobuf:"varint,37,opt,name=task_version,json=taskVersion,proto3,oneof" json:"task_version,omitempty"` // @gotags: propertyID:"263202"
	// This property is set by the client but is ignored by the server.
	TeamTask *bool `protobuf:"varint,38,opt,name=team_task,json=teamTask,proto3,oneof" json:"team_task,omitempty"` // @gotags: propertyID:"263171"
	// Contains the current time, in UTC, which is used to determine the sort order of objects in a consolidated to-do list.
	ToDoOrdinalDate *int64 `protobuf:"varint,39,opt,name=to_do_ordinal_date,json=toDoOrdinalDate,proto3,oneof" json:"to_do_ordinal_date,omitempty"` // @gotags: propertyID:"267584"
	...
	ToDoSubOrdinal *string `protobuf:"bytes,40,opt,name=to_do_sub_ordinal,json=toDoSubOrdinal,proto3,oneof" json:"to_do_sub_ordinal,omitempty"` // @gotags: propertyID:"267585"
	// Contains user-specifiable text to identify this Message object in a consolidated to-do list.
	ToDoTitle *string `protobuf:"bytes,41,opt,name=to_do_title,json=toDoTitle,proto3,oneof" json:"to_do_title,omitempty"` // @gotags: propertyID:"267588"
	...
	ValidFlagStringProof *int64 `protobuf:"varint,42,opt,name=valid_flag_string_proof,json=validFlagStringProof,proto3,oneof" json:"valid_flag_string_proof,omitempty"` // @gotags: propertyID:"267631"
	...
	OrdinalMost *int32 `protobuf:"varint,43,opt,name=ordinal_most,json=ordinalMost,proto3,oneof" json:"ordinal_most,omitempty"` // @gotags: propertyID:"14050"
}

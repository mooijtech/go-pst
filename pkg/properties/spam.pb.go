...
type Spam struct {
	...
	JunkAddRecipientsToSafeSendersList *int32 `protobuf:"varint,2,opt,name=junk_add_recipients_to_safe_senders_list,json=junkAddRecipientsToSafeSendersList,proto3,oneof" json:"junk_add_recipients_to_safe_senders_list,omitempty" msg:"24835,omitempty" type:"3,omitempty"`  
	...
	JunkIncludeContacts *int32 `protobuf:"varint,3,opt,name=junk_include_contacts,json=junkIncludeContacts,proto3,oneof" json:"junk_include_contacts,omitempty" msg:"24832,omitempty" type:"3,omitempty"`  
	// Indicates whether messages identified as spam can be permanently deleted.
	JunkPermanentlyDelete *int32 `protobuf:"varint,4,opt,name=junk_permanently_delete,json=junkPermanentlyDelete,proto3,oneof" json:"junk_permanently_delete,omitempty" msg:"24834,omitempty" type:"3,omitempty"`  
	// Indicated whether the phishing stamp on a message is to be ignored.
	JunkPhishingEnableLinks *bool `protobuf:"varint,5,opt,name=junk_phishing_enable_links,json=junkPhishingEnableLinks,proto3,oneof" json:"junk_phishing_enable_links,omitempty" msg:"24839,omitempty" type:"11,omitempty"`  
	// Indicates how aggressively incoming email is to be sent to the Junk Email folder.
	JunkThreshold *int32 `protobuf:"varint,6,opt,name=junk_threshold,json=junkThreshold,proto3,oneof" json:"junk_threshold,omitempty" msg:"24833,omitempty" type:"3,omitempty"`  
}

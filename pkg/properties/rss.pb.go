...
type RSS struct {
	...
	PostRssChannel *string `protobuf:"bytes,1,opt,name=post_rss_channel,json=postRssChannel,proto3,oneof" json:"post_rss_channel,omitempty" msg:"3507631,omitempty"`  
	// Contains the URL of the RSS or Atom feed from which the XML file came.
	PostRssChannelLink *string `protobuf:"bytes,2,opt,name=post_rss_channel_link,json=postRssChannelLink,proto3,oneof" json:"post_rss_channel_link,omitempty" msg:"3507231,omitempty"`  
	// Contains a unique identifier for the RSS object.
	PostRssItemGuid *string `protobuf:"bytes,3,opt,name=post_rss_item_guid,json=postRssItemGuid,proto3,oneof" json:"post_rss_item_guid,omitempty" msg:"3507531,omitempty"`  
	// Contains a hash of the feed XML computed by using an implementation-dependent algorithm.
	PostRssItemHash *int32 `protobuf:"varint,4,opt,name=post_rss_item_hash,json=postRssItemHash,proto3,oneof" json:"post_rss_item_hash,omitempty" msg:"350743,omitempty"`  
	// Contains the URL of the link from an RSS or Atom item.
	PostRssItemLink *string `protobuf:"bytes,5,opt,name=post_rss_item_link,json=postRssItemLink,proto3,oneof" json:"post_rss_item_link,omitempty" msg:"3507331,omitempty"`  
	...
	PostRssItemXml *string `protobuf:"bytes,6,opt,name=post_rss_item_xml,json=postRssItemXml,proto3,oneof" json:"post_rss_item_xml,omitempty" msg:"3507731,omitempty"`  
	// Contains the user's preferred name for the RSS or Atom subscription.
	PostRssSubscription *string `protobuf:"bytes,7,opt,name=post_rss_subscription,json=postRssSubscription,proto3,oneof" json:"post_rss_subscription,omitempty" msg:"3507831,omitempty"`  
}

...
type Sharing struct {
	...
	SharingAnonymity *int32 `protobuf:"varint,1,opt,name=sharing_anonymity,json=sharingAnonymity,proto3,oneof" json:"sharing_anonymity,omitempty"` // @gotags: propertyID:"272425"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingBrowseUrl *string `protobuf:"bytes,3,opt,name=sharing_browse_url,json=sharingBrowseUrl,proto3,oneof" json:"sharing_browse_url,omitempty"` // @gotags: propertyID:"272545"
	// Indicates that the Message object relates to a special folder.
	SharingCapabilities *int32 `protobuf:"varint,4,opt,name=sharing_capabilities,json=sharingCapabilities,proto3,oneof" json:"sharing_capabilities,omitempty"` // @gotags: propertyID:"272423"
	// Contains a zero-length string.
	SharingConfigurationUrl *string `protobuf:"bytes,5,opt,name=sharing_configuration_url,json=sharingConfigurationUrl,proto3,oneof" json:"sharing_configuration_url,omitempty"` // @gotags: propertyID:"272452"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingDataRangeEnd *int64 `protobuf:"varint,6,opt,name=sharing_data_range_end,json=sharingDataRangeEnd,proto3,oneof" json:"sharing_data_range_end,omitempty"` // @gotags: propertyID:"272517"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingDataRangeStart *int64 `protobuf:"varint,7,opt,name=sharing_data_range_start,json=sharingDataRangeStart,proto3,oneof" json:"sharing_data_range_start,omitempty"` // @gotags: propertyID:"272516"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingDetail *int32 `protobuf:"varint,8,opt,name=sharing_detail,json=sharingDetail,proto3,oneof" json:"sharing_detail,omitempty"` // @gotags: propertyID:"272459"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingExtensionXml *string `protobuf:"bytes,9,opt,name=sharing_extension_xml,json=sharingExtensionXml,proto3,oneof" json:"sharing_extension_xml,omitempty"` // @gotags: propertyID:"272449"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingFlags *int32 `protobuf:"varint,11,opt,name=sharing_flags,json=sharingFlags,proto3,oneof" json:"sharing_flags,omitempty"` // @gotags: propertyID:"272394"
	// Indicates the type of Sharing Message object.
	SharingFlavor *int32 `protobuf:"varint,12,opt,name=sharing_flavor,json=sharingFlavor,proto3,oneof" json:"sharing_flavor,omitempty"` // @gotags: propertyID:"272424"
	...
	SharingInitiatorName *string `protobuf:"bytes,16,opt,name=sharing_initiator_name,json=sharingInitiatorName,proto3,oneof" json:"sharing_initiator_name,omitempty"` // @gotags: propertyID:"272391"
	...
	SharingInitiatorSmtp *string `protobuf:"bytes,17,opt,name=sharing_initiator_smtp,json=sharingInitiatorSmtp,proto3,oneof" json:"sharing_initiator_smtp,omitempty"` // @gotags: propertyID:"272392"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingLastAutoSyncTime *int64 `protobuf:"varint,19,opt,name=sharing_last_auto_sync_time,json=sharingLastAutoSyncTime,proto3,oneof" json:"sharing_last_auto_sync_time,omitempty"` // @gotags: propertyID:"272549"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingLastSyncTime *int64 `protobuf:"varint,20,opt,name=sharing_last_sync_time,json=sharingLastSyncTime,proto3,oneof" json:"sharing_last_sync_time,omitempty"` // @gotags: propertyID:"272431"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingLocalComment *string `protobuf:"bytes,21,opt,name=sharing_local_comment,json=sharingLocalComment,proto3,oneof" json:"sharing_local_comment,omitempty"` // @gotags: propertyID:"272525"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingLocalLastModificationTime *int64 `protobuf:"varint,22,opt,name=sharing_local_last_modification_time,json=sharingLocalLastModificationTime,proto3,oneof" json:"sharing_local_last_modification_time,omitempty"` // @gotags: propertyID:"272451"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingLocalName *string `protobuf:"bytes,23,opt,name=sharing_local_name,json=sharingLocalName,proto3,oneof" json:"sharing_local_name,omitempty"` // @gotags: propertyID:"272399"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingLocalPath *string `protobuf:"bytes,24,opt,name=sharing_local_path,json=sharingLocalPath,proto3,oneof" json:"sharing_local_path,omitempty"` // @gotags: propertyID:"272398"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingLocalStoreUid *string `protobuf:"bytes,25,opt,name=sharing_local_store_uid,json=sharingLocalStoreUid,proto3,oneof" json:"sharing_local_store_uid,omitempty"` // @gotags: propertyID:"272521"
	// Contains the value of the PidTagContainerClass property (section 2.642) of the folder being shared.
	SharingLocalType *string `protobuf:"bytes,26,opt,name=sharing_local_type,json=sharingLocalType,proto3,oneof" json:"sharing_local_type,omitempty"` // @gotags: propertyID:"272420"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingLocalUid *string `protobuf:"bytes,27,opt,name=sharing_local_uid,json=sharingLocalUid,proto3,oneof" json:"sharing_local_uid,omitempty"` // @gotags: propertyID:"272416"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingParticipants *string `protobuf:"bytes,30,opt,name=sharing_participants,json=sharingParticipants,proto3,oneof" json:"sharing_participants,omitempty"` // @gotags: propertyID:"272430"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingPermissions *int32 `protobuf:"varint,31,opt,name=sharing_permissions,json=sharingPermissions,proto3,oneof" json:"sharing_permissions,omitempty"` // @gotags: propertyID:"272427"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingProviderExtension *string `protobuf:"bytes,32,opt,name=sharing_provider_extension,json=sharingProviderExtension,proto3,oneof" json:"sharing_provider_extension,omitempty"` // @gotags: propertyID:"272395"
	...
	SharingProviderName *string `protobuf:"bytes,34,opt,name=sharing_provider_name,json=sharingProviderName,proto3,oneof" json:"sharing_provider_name,omitempty"` // @gotags: propertyID:"272386"
	// Contains a URL related to the sharing provider identified by the PidLidSharingProviderGuid property (section 2.266).
	SharingProviderUrl *string `protobuf:"bytes,35,opt,name=sharing_provider_url,json=sharingProviderUrl,proto3,oneof" json:"sharing_provider_url,omitempty"` // @gotags: propertyID:"272387"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingRangeEnd *int32 `protobuf:"varint,36,opt,name=sharing_range_end,json=sharingRangeEnd,proto3,oneof" json:"sharing_range_end,omitempty"` // @gotags: propertyID:"272519"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingRangeStart *int32 `protobuf:"varint,37,opt,name=sharing_range_start,json=sharingRangeStart,proto3,oneof" json:"sharing_range_start,omitempty"` // @gotags: propertyID:"272518"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingReciprocation *int32 `protobuf:"varint,38,opt,name=sharing_reciprocation,json=sharingReciprocation,proto3,oneof" json:"sharing_reciprocation,omitempty"` // @gotags: propertyID:"272426"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingRemoteByteSize *int32 `protobuf:"varint,39,opt,name=sharing_remote_byte_size,json=sharingRemoteByteSize,proto3,oneof" json:"sharing_remote_byte_size,omitempty"` // @gotags: propertyID:"272523"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingRemoteComment *string `protobuf:"bytes,40,opt,name=sharing_remote_comment,json=sharingRemoteComment,proto3,oneof" json:"sharing_remote_comment,omitempty"` // @gotags: propertyID:"272463"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingRemoteCrc *int32 `protobuf:"varint,41,opt,name=sharing_remote_crc,json=sharingRemoteCrc,proto3,oneof" json:"sharing_remote_crc,omitempty"` // @gotags: propertyID:"272524"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingRemoteLastModificationTime *int64 `protobuf:"varint,42,opt,name=sharing_remote_last_modification_time,json=sharingRemoteLastModificationTime,proto3,oneof" json:"sharing_remote_last_modification_time,omitempty"` // @gotags: propertyID:"272450"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingRemoteMessageCount *int32 `protobuf:"varint,43,opt,name=sharing_remote_message_count,json=sharingRemoteMessageCount,proto3,oneof" json:"sharing_remote_message_count,omitempty"` // @gotags: propertyID:"272527"
	// Contains the value of the PidTagDisplayName property (section 2.676) on the folder being shared.
	SharingRemoteName *string `protobuf:"bytes,44,opt,name=sharing_remote_name,json=sharingRemoteName,proto3,oneof" json:"sharing_remote_name,omitempty"` // @gotags: propertyID:"272389"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingRemotePass *string `protobuf:"bytes,45,opt,name=sharing_remote_pass,json=sharingRemotePass,proto3,oneof" json:"sharing_remote_pass,omitempty"` // @gotags: propertyID:"272397"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingRemotePath *string `protobuf:"bytes,46,opt,name=sharing_remote_path,json=sharingRemotePath,proto3,oneof" json:"sharing_remote_path,omitempty"` // @gotags: propertyID:"272388"
	...
	SharingRemoteStoreUid *string `protobuf:"bytes,47,opt,name=sharing_remote_store_uid,json=sharingRemoteStoreUid,proto3,oneof" json:"sharing_remote_store_uid,omitempty"` // @gotags: propertyID:"272520"
	// Contains the same value as the PidLidSharingLocalType property (section 2.259).
	SharingRemoteType *string `protobuf:"bytes,48,opt,name=sharing_remote_type,json=sharingRemoteType,proto3,oneof" json:"sharing_remote_type,omitempty"` // @gotags: propertyID:"272429"
	// Contains the EntryID of the folder being shared.
	SharingRemoteUid *string `protobuf:"bytes,49,opt,name=sharing_remote_uid,json=sharingRemoteUid,proto3,oneof" json:"sharing_remote_uid,omitempty"` // @gotags: propertyID:"272390"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingRemoteUser *string `protobuf:"bytes,50,opt,name=sharing_remote_user,json=sharingRemoteUser,proto3,oneof" json:"sharing_remote_user,omitempty"` // @gotags: propertyID:"272396"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingRemoteVersion *string `protobuf:"bytes,51,opt,name=sharing_remote_version,json=sharingRemoteVersion,proto3,oneof" json:"sharing_remote_version,omitempty"` // @gotags: propertyID:"272555"
	// Contains the time at which the recipient of the sharing request sent a sharing response.
	SharingResponseTime *int64 `protobuf:"varint,52,opt,name=sharing_response_time,json=sharingResponseTime,proto3,oneof" json:"sharing_response_time,omitempty"` // @gotags: propertyID:"272456"
	// Contains the type of response with which the recipient of the sharing request responded.
	SharingResponseType *int32 `protobuf:"varint,53,opt,name=sharing_response_type,json=sharingResponseType,proto3,oneof" json:"sharing_response_type,omitempty"` // @gotags: propertyID:"272455"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingRoamLog *int32 `protobuf:"varint,54,opt,name=sharing_roam_log,json=sharingRoamLog,proto3,oneof" json:"sharing_roam_log,omitempty"` // @gotags: propertyID:"272526"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingStart *int64 `protobuf:"varint,55,opt,name=sharing_start,json=sharingStart,proto3,oneof" json:"sharing_start,omitempty"` // @gotags: propertyID:"272453"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingStatus *int32 `protobuf:"varint,56,opt,name=sharing_status,json=sharingStatus,proto3,oneof" json:"sharing_status,omitempty"` // @gotags: propertyID:"272384"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingStop *int64 `protobuf:"varint,57,opt,name=sharing_stop,json=sharingStop,proto3,oneof" json:"sharing_stop,omitempty"` // @gotags: propertyID:"272454"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingSyncFlags *int32 `protobuf:"varint,58,opt,name=sharing_sync_flags,json=sharingSyncFlags,proto3,oneof" json:"sharing_sync_flags,omitempty"` // @gotags: propertyID:"272576"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingSyncInterval *int32 `protobuf:"varint,59,opt,name=sharing_sync_interval,json=sharingSyncInterval,proto3,oneof" json:"sharing_sync_interval,omitempty"` // @gotags: propertyID:"272458"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingTimeToLive *int32 `protobuf:"varint,60,opt,name=sharing_time_to_live,json=sharingTimeToLive,proto3,oneof" json:"sharing_time_to_live,omitempty"` // @gotags: propertyID:"272460"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingTimeToLiveAuto *int32 `protobuf:"varint,61,opt,name=sharing_time_to_live_auto,json=sharingTimeToLiveAuto,proto3,oneof" json:"sharing_time_to_live_auto,omitempty"` // @gotags: propertyID:"272550"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingWorkingHoursDays *int32 `protobuf:"varint,62,opt,name=sharing_working_hours_days,json=sharingWorkingHoursDays,proto3,oneof" json:"sharing_working_hours_days,omitempty"` // @gotags: propertyID:"272514"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingWorkingHoursEnd *int64 `protobuf:"varint,63,opt,name=sharing_working_hours_end,json=sharingWorkingHoursEnd,proto3,oneof" json:"sharing_working_hours_end,omitempty"` // @gotags: propertyID:"272513"
	// Contains a value that is ignored by the server no matter what value is generated by the client.
	SharingWorkingHoursStart *int64 `protobuf:"varint,64,opt,name=sharing_working_hours_start,json=sharingWorkingHoursStart,proto3,oneof" json:"sharing_working_hours_start,omitempty"` // @gotags: propertyID:"272512"
	// Contains a value that is ignored by the server no matter what value is generated by the client.

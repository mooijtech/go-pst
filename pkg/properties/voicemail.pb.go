...
type Voicemail struct {
	...
	// Contains a unique identifier associated with the phone call.
	CallId *string `protobuf:"bytes,10,opt,name=call_id,json=callId,proto3,oneof" json:"call_id,omitempty" msg:"26630,omitempty" type:"31,omitempty"`  
	// Contains the number of pages in a Fax object.
	FaxNumberOfPages *int32 `protobuf:"varint,11,opt,name=fax_number_of_pages,json=faxNumberOfPages,proto3,oneof" json:"fax_number_of_pages,omitempty" msg:"26628,omitempty" type:"3,omitempty"`  
	// Contains the telephone number of the caller associated with a voice mail message.
	SenderTelephoneNumber *string `protobuf:"bytes,12,opt,name=sender_telephone_number,json=senderTelephoneNumber,proto3,oneof" json:"sender_telephone_number,omitempty" msg:"26626,omitempty" type:"31,omitempty"`  
	// Contains a list of file names for the audio file attachments that are to be played as part of a message.
	VoiceMessageAttachmentOrder *string `protobuf:"bytes,13,opt,name=voice_message_attachment_order,json=voiceMessageAttachmentOrder,proto3,oneof" json:"voice_message_attachment_order,omitempty" msg:"26629,omitempty" type:"31,omitempty"`  
	// Specifies the length of the attached audio message, in seconds.
	VoiceMessageDuration *int32 `protobuf:"varint,14,opt,name=voice_message_duration,json=voiceMessageDuration,proto3,oneof" json:"voice_message_duration,omitempty" msg:"26625,omitempty" type:"3,omitempty"`  
	// Specifies the name of the caller who left the attached voice message, as provided by the voice network's caller ID system.
	VoiceMessageSenderName *string `protobuf:"bytes,15,opt,name=voice_message_sender_name,json=voiceMessageSenderName,proto3,oneof" json:"voice_message_sender_name,omitempty" msg:"26627,omitempty" type:"31,omitempty"`  
}

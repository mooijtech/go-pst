...
type Voicemail struct {
	...
	// Contains a unique identifier associated with the phone call.
	CallId *string `protobuf:"bytes,10,opt,name=call_id,json=callId,proto3,oneof" json:"call_id,omitempty"` // @gotags: propertyID:"26630"
	// Contains the number of pages in a Fax object.
	FaxNumberOfPages *int32 `protobuf:"varint,11,opt,name=fax_number_of_pages,json=faxNumberOfPages,proto3,oneof" json:"fax_number_of_pages,omitempty"` // @gotags: propertyID:"26628"
	// Contains the telephone number of the caller associated with a voice mail message.
	SenderTelephoneNumber *string `protobuf:"bytes,12,opt,name=sender_telephone_number,json=senderTelephoneNumber,proto3,oneof" json:"sender_telephone_number,omitempty"` // @gotags: propertyID:"26626"
	// Contains a list of file names for the audio file attachments that are to be played as part of a message.
	VoiceMessageAttachmentOrder *string `protobuf:"bytes,13,opt,name=voice_message_attachment_order,json=voiceMessageAttachmentOrder,proto3,oneof" json:"voice_message_attachment_order,omitempty"` // @gotags: propertyID:"26629"
	// Specifies the length of the attached audio message, in seconds.
	VoiceMessageDuration *int32 `protobuf:"varint,14,opt,name=voice_message_duration,json=voiceMessageDuration,proto3,oneof" json:"voice_message_duration,omitempty"` // @gotags: propertyID:"26625"
	// Specifies the name of the caller who left the attached voice message, as provided by the voice network's caller ID system.
	VoiceMessageSenderName *string `protobuf:"bytes,15,opt,name=voice_message_sender_name,json=voiceMessageSenderName,proto3,oneof" json:"voice_message_sender_name,omitempty"` // @gotags: propertyID:"26627"
}

...
type Attachment struct {
	...
	AttachContentBase *string `protobuf:"bytes,7,opt,name=attach_content_base,json=attachContentBase,proto3,oneof" json:"attach_content_base,omitempty"` // @gotags: propertyID:"14097"
	...
	AttachContentId *string `protobuf:"bytes,8,opt,name=attach_content_id,json=attachContentId,proto3,oneof" json:"attach_content_id,omitempty"` // @gotags: propertyID:"14098"
	// Contains a relative or full URI that matches a corresponding reference in the HTML body of a Message object.
	AttachContentLocation *string `protobuf:"bytes,9,opt,name=attach_content_location,json=attachContentLocation,proto3,oneof" json:"attach_content_location,omitempty"` // @gotags: propertyID:"14099"
	// Contains a file name extension that indicates the document type of an attachment.
	AttachExtension *string `protobuf:"bytes,13,opt,name=attach_extension,json=attachExtension,proto3,oneof" json:"attach_extension,omitempty"` // @gotags: propertyID:"14083"
	// Contains the 8.3 name of the PidTagAttachLongFilename property (section 2.595).
	AttachFilename *string `protobuf:"bytes,14,opt,name=attach_filename,json=attachFilename,proto3,oneof" json:"attach_filename,omitempty"` // @gotags: propertyID:"14084"
	// Indicates which body formats might reference this attachment when rendering data.
	AttachFlags *int32 `protobuf:"varint,15,opt,name=attach_flags,json=attachFlags,proto3,oneof" json:"attach_flags,omitempty"` // @gotags: propertyID:"14100"
	// Contains the full filename and extension of the Attachment object.
	AttachLongFilename *string `protobuf:"bytes,16,opt,name=attach_long_filename,json=attachLongFilename,proto3,oneof" json:"attach_long_filename,omitempty"` // @gotags: propertyID:"14087"
	// Contains the fully-qualified path and file name with extension.
	AttachLongPathname *string `protobuf:"bytes,17,opt,name=attach_long_pathname,json=attachLongPathname,proto3,oneof" json:"attach_long_pathname,omitempty"` // @gotags: propertyID:"14093"
	// Indicates that a contact photo attachment is attached to a Contact object.
	AttachmentContactPhoto *bool `protobuf:"varint,18,opt,name=attachment_contact_photo,json=attachmentContactPhoto,proto3,oneof" json:"attachment_contact_photo,omitempty"` // @gotags: propertyID:"32767"
	// Indicates special handling for an Attachment object.
	AttachmentFlags *int32 `protobuf:"varint,19,opt,name=attachment_flags,json=attachmentFlags,proto3,oneof" json:"attachment_flags,omitempty"` // @gotags: propertyID:"32765"
	// Indicates whether an Attachment object is hidden from the end user.
	AttachmentHidden *bool `protobuf:"varint,20,opt,name=attachment_hidden,json=attachmentHidden,proto3,oneof" json:"attachment_hidden,omitempty"` // @gotags: propertyID:"32766"
	// Contains the type of Message object to which an attachment is linked.
	AttachmentLinkId *int32 `protobuf:"varint,21,opt,name=attachment_link_id,json=attachmentLinkId,proto3,oneof" json:"attachment_link_id,omitempty"` // @gotags: propertyID:"32762"
	// Represents the way the contents of an attachment are accessed.
	AttachMethod *int32 `protobuf:"varint,22,opt,name=attach_method,json=attachMethod,proto3,oneof" json:"attach_method,omitempty"` // @gotags: propertyID:"14085"
	// Contains a content-type MIME header.
	AttachMimeTag *string `protobuf:"bytes,23,opt,name=attach_mime_tag,json=attachMimeTag,proto3,oneof" json:"attach_mime_tag,omitempty"` // @gotags: propertyID:"14094"
	// Identifies the Attachment object within its Message object.
	AttachNumber *int32 `protobuf:"varint,24,opt,name=attach_number,json=attachNumber,proto3,oneof" json:"attach_number,omitempty"` // @gotags: propertyID:"3617"
	// Contains the 8.3 name of the PidTagAttachLongPathname property (section 2.596).
	AttachPathname *string `protobuf:"bytes,25,opt,name=attach_pathname,json=attachPathname,proto3,oneof" json:"attach_pathname,omitempty"` // @gotags: propertyID:"14088"
	// Contains the size, in bytes, consumed by the Attachment object on the server.
	AttachSize *int32 `protobuf:"varint,27,opt,name=attach_size,json=attachSize,proto3,oneof" json:"attach_size,omitempty"` // @gotags: propertyID:"3616"
	// Contains the name of an attachment file, modified so that it can be correlated with TNEF messages.
	AttachTransportName *string `protobuf:"bytes,29,opt,name=attach_transport_name,json=attachTransportName,proto3,oneof" json:"attach_transport_name,omitempty"` // @gotags: propertyID:"14092"
	// Specifies the character set of an attachment received via MIME with the content-type of text.
	TextAttachmentCharset *string `protobuf:"bytes,31,opt,name=text_attachment_charset,json=textAttachmentCharset,proto3,oneof" json:"text_attachment_charset,omitempty"` // @gotags: propertyID:"14107"
}
